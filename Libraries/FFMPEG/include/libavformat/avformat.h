...
typedef struct AVInputFormat {
     ...
     * AVFMTCTX_NOHEADER is used and only in the calling mtFrequencyThread (not in a
     * background mtFrequencyThread).
 ...
 *
 * This functions only exists to work around mtFrequencyThread-safety issues
